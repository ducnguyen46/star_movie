...
/// @nodoc
@JsonSerializable()
class _$_CrewModel implements _CrewModel {
  const _$_CrewModel(
  ...
  @override
  String toString() {
    return 'CrewModel(id: $id, castId: $castId, creditId: $creditId, name: $name, job: $job, department: $department, profilePath: $profilePath, popularity: $popularity, gender: $gender)';
  }
...
abstract class _CrewModel implements CrewModel {
  const factory _CrewModel(
      ...
      @JsonKey(name: 'gender') final int gender}) = _$_CrewModel;
