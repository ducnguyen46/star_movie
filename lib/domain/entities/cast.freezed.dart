...
class _$CastImpl implements _Cast {
  ...
  @override
  String toString() {
    return 'Cast(id: $id, castId: $castId, creditId: $creditId, name: $name, character: $character, knowForDepartment: $knowForDepartment, profilePath: $profilePath, popularity: $popularity, order: $order, gender: $gender)';
  }
...
abstract class _Cast implements Cast {
  const factory _Cast(
      ...
      required final String knowForDepartment,
      required final String profilePath,
      required final double popularity,
      required final int order,
      required final Gender gender}) = _$CastImpl;
